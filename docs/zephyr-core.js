...
const ZephyrCore = (() => {
  ...
  const COMPONENT_TYPES = [
    "access-gateway", "access-policy", "actor", "application",
    "cloud-identity", "device-management", "endpoint", "identity",
    "identity-provider", "on-prem-identity", "on-prem-resource", "pki",
  ...
  const TEMPLATES = {
    ...
    "hybrid-identity": {
      ...
      risks: [
        {
          id: "R1",
          title: "Single VPN gateway creates availability risk",
          severity: "high",
          likelihood: "medium",
          impact: "high",
          mitigation: "Deploy redundant VPN gateways across availability zones.",
        },
        {
          id: "R2",
          title: "Trust boundary between cloud and on-prem identity unclear",
          severity: "high",
          likelihood: "high",
          impact: "high",
          mitigation: "Implement Entra ID Kerberos and enforce Conditional Access for on-prem resource access.",
        },
        {
          id: "R3",
          title: "Certificate expiry may silently break access",
          severity: "medium",
          likelihood: "medium",
          impact: "high",
          mitigation: "Configure auto-renewal via SCEP and alert on upcoming expirations.",
        },
      ],
      controls: [
        {
          name: "enforce-mfa",
          type: "technical",
          applies_to: ["entra-id","conditional-access"],
          description: "Require MFA for all cloud identity authentication flows.",
        },
        {
          name: "cert-renewal",
          type: "process",
          applies_to: ["pki","endpoint"],
          description: "Quarterly certificate review with automated SCEP renewal.",
        },
      ],
      stakeholders: [
        {
    ...
    "zero-trust": {
      ...
      flows: [
        ...
        },
        {
          ...
          label: "forward authorised request",
          protocol: "https",
          encryption: "tls",
          direction: "outbound",
        },
      ...
      risks: [
        {
          id: "R1",
          title: "Identity provider is a single point of trust failure",
          severity: "critical",
          likelihood: "low",
          impact: "high",
          mitigation: "Deploy identity provider in high-availability configuration with failover.",
        },
        {
          id: "R2",
          title: "Device attestation not enforced at access gateway",
          severity: "high",
          likelihood: "medium",
          impact: "high",
          mitigation: "Require device compliance signal from device-management before forwarding requests.",
        },
        {
          id: "R3",
          title: "Access policy gaps may allow lateral movement",
          severity: "high",
          likelihood: "medium",
          impact: "high",
          mitigation: "Apply least-privilege policies per resource and review quarterly.",
        },
      ],
      controls: [
        {
          ...
          type: "technical",
          applies_to: ["identity-provider","access-gateway","access-policy"],
          description: "Re-verify identity and device posture on every request, not just at login.",
        },
        {
          name: "least-privilege-policy",
          type: "policy",
          applies_to: ["access-policy","protected-resource"],
          description: "Grant minimum required permissions per resource; no standing access.",
        },
        {
          name: "access-review",
          type: "process",
          applies_to: ["access-policy"],
          description: "Quarterly review of all access policies and permission grants.",
        },
      ],
      stakeholders: [
        {
